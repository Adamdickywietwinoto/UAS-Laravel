...
class Controllers extends Controller
{
    ...
    if (Auth::attempt($credentials)) {
        ...
        if (!$user->hasVerifiedEmail()) {
            Auth::logout();
            return redirect()->route('login')->with('error', 'verifikasi email terlebih dahulu.');
        }
    ...
    public function handleGoogleCallback()
    {
        try {
            ...
            return redirect('/login')->with('error', 'Terjadi masalah saat masuk menggunakan Google. Coba lagi.');
        }
    }
